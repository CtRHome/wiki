::media right
url: fandom.webp
caption: Screenshot of a fresh virtual machine visiting [cuttherope.fandom.com/wiki/Om\_Nom](https://cuttherope.fandom.com/wiki/Om_Nom), shown before any personalization or user consent.
-# (red regions are ad fields, orange regions are other bloat)
::
